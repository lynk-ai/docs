---
description: The evidence behind living sources — split and merge signals with thresholds, and the cost of leaving them unattended. Open when the call is close.
layer: deep
...
Signals (from the concept card): two-questions-one-page, caveat walls, readers quoting different parts, chunk boundaries cutting concepts. Procedure:
