---
description: The evidence behind self compiled vs curated — both failure directions with evidence, and how to set merge rights. Open when deciding a real gate.
layer: deep
