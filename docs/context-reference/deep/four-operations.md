---
description: The evidence behind four operations — each operation in depth plus the two the taxonomy misses. Open when designing the machinery, not choosing a lever.
layer: deep
