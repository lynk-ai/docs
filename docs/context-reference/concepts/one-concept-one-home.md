...
**Go deeper** — [`deep/one-concept-one-home.md`](../deep/one-concept-one-home.md) has how duplication fails silently, with the contradiction studies. Read it when structuring a corpus/KB, deciding where a fact lives, handling mirrors and exports, or a contradiction just surfaced.
