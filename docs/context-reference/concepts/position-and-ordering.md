...
**Go deeper** — [`deep/position-and-ordering.md`](../deep/position-and-ordering.md) has the U-curve evidence and placement rules with numbers. Read it when designing a prompt/agent-loop layout, debugging "the answer was in context and it still missed it," or ordering retrieved evidence.
