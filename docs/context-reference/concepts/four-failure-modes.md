...
**Go deeper** (`../deep/four-failure-modes.md`) when: an agent is misbehaving and you need the diagnostic procedure, the fix menu with evidence, or the knowledge-conflict handling patterns.

## Related

- [Deep: the evidence behind this page](../deep/four-failure-modes.md) — open it on the trigger named above.
