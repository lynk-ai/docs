...
**Go deeper** (`../deep/caching-economics.md`) when: designing an agent loop's message layout, costing a system, or diagnosing latency/cost spikes.

## Related

- [Deep: the evidence behind this page](../deep/caching-economics.md) — open it on the trigger named above.
