...
**Go deeper** (`../deep/self-compiled-vs-curated.md`) when: designing memory write paths, deciding review policy for agent-generated docs, or writing/pruning context files (CLAUDE.md, AGENTS.md).

## Related

- [Deep: the evidence behind this page](../deep/self-compiled-vs-curated.md) — open it on the trigger named above.
