...
Lynk connects to your data warehouse with read-only access. Supported warehouses: **Snowflake** and **BigQuery**. Customers also run Lynk against Presto, Athena, Spark, and Hive.
...
|---|---|
| Understand the vocabulary (Entity, Feature, Metric, etc.) | [Main Concepts](main-concepts.md) |
| See every file type and what it does | [File Types](file-types.md) |
