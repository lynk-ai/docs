...
| Page | What it covers |
|---|---|
| [Lynk SQL](lynk-sql.md) | The SQL dialect the agent uses internally and you use when writing evaluation test cases — entity references, `METRIC('<metric_name>')`, joins (default, `USING`, `ON`), CTEs, supported statements |
